...
class WeatherAppTests(TestCase):
    ...
    def test_valid_city(self, mock_get_daily_forecast, mock_get_weather_data):
        ...
        mock_get_daily_forecast.return_value = [
            {'day': '2024-07-17 12:00:00', 'min_temp': 10, 'max_temp': 20, 'description': 'clear sky', 'icon': '01d'},
            {'day': '2024-07-18 12:00:00', 'min_temp': 12, 'max_temp': 22, 'description': 'light rain', 'icon': '10d'},
            {'day': '2024-07-19 12:00:00', 'min_temp': 14, 'max_temp': 24, 'description': 'scattered clouds', 'icon': '03d'}
        ]
